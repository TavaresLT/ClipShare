...
namespace ClipShare.ViewModels.Account
{
    public class RegisterViewModel : ViewModel
    {
        ...
        [RegularExpression("^(?=.*[0-9]+.*)(?=.*[a-zA-Z]+.*)[0-9a-zA-Z]{6,15}$", ErrorMessage = 
            @"Password must contains at least one letter, at least one number, 
                and be between 6-15 characters in length with no special characters")]
